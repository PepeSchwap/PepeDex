      ...
      <PaddedColumn>
        <AutoColumn gap="14px">
          ...
          <Text style={{ marginBottom: '8px', textAlign: 'center' }}>
            PEPE Dex supports token lists. You can add your own custom lists via HTTPS and ENS.
          </Text>
          ...
          <OutlineCard style={{ marginBottom: '8px', padding: '1rem' }}>
            <Text fontWeight={400} fontSize={14} style={{ textAlign: 'center' }}>
              Token lists are an{''}
              <ExternalLink href="https://tokenlists.org">open specification</ExternalLink>. Check out{' '}
